...
// Fix: Extend HTMLMotionProps to avoid conflicts with Framer Motion props arzish gay 2
    ...
    <div className="min-h-screen pt-24 pb-16 px-6 bg-black">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="bg-gradient-to-br from-gray-900 to-black rounded-3xl p-8 md:p-12 border border-white/10 shadow-2xl"
        >
          {/* Header */}
            ...
            {isEditing ? (
              ...
              <>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center gap-3 bg-blue-500 text-white rounded-xl px-6 py-4 font-medium"
                >
                  <Phone size={20} />
                  Call
                </motion.button>
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center gap-3 bg-white/10 text-white rounded-xl px-6 py-4 font-medium"
                >
                  <Mail size={20} />
                  Email
                </motion.button>
                ...
                <motion.button
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex items-center justify-center gap-3 bg-green-500 text-white rounded-xl px-6 py-4 font-medium"
                >
                  💰 Pay via UPI
                </motion.button>
              </>
              ...
              <div className="flex gap-4">
                {[
                  ...
                  <motion.button
                    ...
                    whileHover={{ scale: 1.1, y: -2 }}
                    whileTap={{ scale: 0.95 }}
                    className="w-12 h-12 bg-white/10 rounded-xl flex items-center justify-center hover:bg-blue-500/20 transition-colors"
                  >
          ...
          {!isEditing && (
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full mt-8 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-xl py-4 font-semibold text-lg"
            >
              💾 Save Contact
            </motion.button>
          )}
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black rounded-2xl p-8 border border-white/10">
              ...
              <div className="space-y-6">
                <motion.a
                  ...
                  whileHover={{ scale: 1.05 }}
                  className="flex items-center gap-4 p-4 bg-green-500/20 rounded-xl border border-green-500/30 hover:bg-green-500/30 transition-colors"
                >
